        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg sm:text-xl text-sky-100/90 max-w-2xl">
              Edaptix connects teachers and students with tools for live lessons, recorded courses,
              customizable assessments and AI-assisted grading — so students get personalized help and
            ...
            <div className="rounded-2xl bg-white/5 p-6 shadow-xl backdrop-blur-sm border border-white/10">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <div className="text-lg font-semibold">Introduction to Data Structures</div>
                </div>
              ...
              <div className="bg-indigo rounded-lg p-4">
                <Image src="https://thedigitaladda.com/wp-content/uploads/Data-Structure-Algorithms.png" alt="Course screenshot" width={720} height={420} className="rounded" />
                <div className="mt-3 flex justify-between items-center">
                  <div className="text-sm text-white">8 lessons • 2 assessments</div>
                </div>
              </div>

              <div className="mt-4 flex gap-3">
                <Link href="/signup" className="px-4 py-2 bg-teal text-white rounded-md">Enroll</Link>
                <Link href="/signin" className="px-4 py-2 border rounded-md text-white/90">Preview</Link>
              </div>
            </div>
...
function Icon({ name }: { name: string }) {
  ...
  switch (name) {
    case "book":
      return (
        <svg className={common} viewBox="0 0 24 24" fill="none" aria-hidden>
          <path d="M3 6a2 2 0 0 1 2-2h12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M5 20a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      );
    case "spark":
      return (
    ...
    case "chart":
      return (
        <svg className={common} viewBox="0 0 24 24" fill="none" aria-hidden>
          ...
          <path d="M12 7v11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M17 10v8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      );
    case "edit":
      return (
        <svg className={common} viewBox="0 0 24 24" fill="none" aria-hidden>
          <path d="M3 21l3-1 11-11a2.828 2.828 0 0 0 0-4l-2-2a2.828 2.828 0 0 0-4 0L6 13 5 16 3 21z" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      );
    case "auto":
      return (
    ...
    case "wallet":
      return (
        <svg className={common} viewBox="0 0 24 24" fill="none" aria-hidden>
          <path d="M2 7h18v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7z" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M22 11v2" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      );
    default:
      return null;
        ...
        <div className="lg:col-span-7">
          <div className="rounded-3xl bg-gradient-to-b from-slate-50 via-slate-100 to-slate-200 p-8 border border-slate-200 shadow-md">
            <div className="flex flex-col items-start justify-between gap-4">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold text-slate-900">Designed for students — learning that actually works</h2>
                <p className="mt-3 text-slate-500 max-w-2xl">
                  Bite-sized lessons, interactive quizzes and AI feedback create a continuous learning loop so you improve faster.
                </p>
              </div>

              <div className="hidden sm:flex items-center gap-3">
                <Link href={session ? "/dashboard" : "/signin"} className="primary_btn">
                  Get started
                </Link>
                <Link href="/courses" className="primary_btn white_btn">Browse courses</Link>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-white border border-slate-100 p-6 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">Create courses, assessments and grow your classes.</p>
                </div>

                <Link href="/signup" className="primary_btn white_btn !text-sm">Start teaching</Link>
              </div>

              <div className="mt-4 space-y-3">
                {teacherFeatures.map((t) => (
                  <div key={t.title} className="flex gap-3 items-start p-3 rounded-lg border border-slate-100 hover:shadow-sm transition bg-white">
              ...
              <div className="mt-4 flex gap-2">
                <Link href="/dashboard/create-test" className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-indigo text-white">Create test</Link>
                <Link href="/dashboard" className="flex-1 inline-flex items-center justify-center primary_btn white_btn">Dashboard</Link>
              </div>
            </div>

            <div className="rounded-2xl bg-emerald-50 border border-emerald-100 p-4">
              <div className="text-sm font-semibold text-emerald-800">Why teachers love Edaptix</div>
